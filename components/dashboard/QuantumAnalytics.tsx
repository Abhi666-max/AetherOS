  ...
  return (
    <div className="space-y-12 pb-16 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-white/10 pb-8">
        ...
        {/* Timeframe Pills */}
        <div className="flex items-center gap-1 bg-[#05050a]/80 p-1.5 rounded-xl border border-white/10 backdrop-blur-xl self-start md:self-auto">
      ...
      {/* 2. Interactive Enterprise Scale ROI Simulator (Reverted: Clean minimal glassmorphism without cheap glows or rotating beams) */}
      <div className="rounded-[24px] bg-[#05050a]/80 border border-white/10 hover:border-white/20 p-8 sm:p-10 backdrop-blur-xl transition-all duration-300 shadow-sm space-y-8">
      ...
      {/* 3. Bloomberg / Palantir Tier Animated Charts (Reverted: Clean minimal glassmorphism without cheap glows or rotating beams) */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        
        {/* Chart 1: YoY Productivity Velocity */}
        <div className="rounded-[24px] bg-[#05050a]/80 hover:bg-[#080812]/90 border border-white/10 hover:border-white/20 p-6 sm:p-8 space-y-6 h-full backdrop-blur-xl transition-all duration-300 hover:scale-[1.02] shadow-sm cursor-pointer group">
          ...
          <div className="relative h-60 w-full flex items-end justify-between pt-8 pb-4 px-2">
            <svg viewBox="0 0 500 200" className="w-full h-full overflow-visible select-none">
              ...
              <line x1="0" y1="100" x2="500" y2="50" stroke="#333" strokeDasharray="4 4" strokeWidth="1" />
